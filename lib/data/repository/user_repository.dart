...
import 'package:flutter_userapp_demo/features/user_list/paginated_user_list/models/paging_helper.dart';
...
class UserRepository{
  ...
  Future<List<User>> fetchPaginatedUserList(filters,PagingHelper _pagingHelper,_refreshPage,bool clearCache)async {
    if(clearCache)
    {
    ...
    List<User> userList = await userApiService.fetchPaginatedUserList(filters, _pagingHelper,_refreshPage);
